...
class UsuarioServiceTest {
    ...
    void buscarPorId_WhenUsuarioNotFound_ShouldThrowException() {
        ...
        assertEquals("Usuário não encontrado com id: " + id, exception.getMessage(), "A mensagem de erro deve ser a esperada");
        verify(usuarioRepository, times(1)).findById(id);
        verifyNoMoreInteractions(usuarioRepository);
        verifyNoInteractions(passwordEncoder);
    }
    ...
    void atualizar_ShouldUpdateUsuario() {
        ...
        usuarioExistente.setPerfil("USER");
        ...
        usuarioAtualizado.setPerfil("ADMIN");
